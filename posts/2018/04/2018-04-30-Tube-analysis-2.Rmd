...
```{r weekly-spending, fig.cap = c('A plot showing my weekly Oyster card spending, September 2014 to May 2018'), warning=FALSE}
...
```{r cumulative-spending, fig.cap = 'A plot showing my cumulative Oyster card spending, September 2014 to May 2018'}
...
```{r zero-spending-weeks, fig.cap = 'A plot showing weeks where I made no journeys using my Oyster card', fig.height = 3, fig.width = 7.5}
...
```{r fare-duration-averages, fig.cap = 'A plot of average fares and journey durations over time', warning = FALSE}
n_journey_avg <- 10
...
```{r fare-duration-scatter, fig.cap = 'A plot of journey fare against distance, grouped by whether the journeys were before or after I moved house', warning = FALSE}
