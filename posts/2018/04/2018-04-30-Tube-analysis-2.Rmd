...
```{r weekly-spending, warning=FALSE}
...
```{r zero-spending-weeks, fig.height=3, fig.width = 7.5}
...
```{r fare-duration-averages, warning = FALSE}
n_journey_avg <- 10
...
```{r fare-against-duration_scatter, warning = FALSE}
