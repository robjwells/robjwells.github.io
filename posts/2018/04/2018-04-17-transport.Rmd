...
joined_weeks %>%
    ggplot(mapping = aes(x = year_week, y = 1,
                         alpha = week_total == 0)) +
    geom_col() +
    scale_y_discrete(limits = c(FALSE, TRUE), labels = NULL, breaks = NULL) +
